...
# camera_centroid_receiver's USART2 rate -- raised from 115200 back to
# 460800 on 2026-08-13, now matching the old "FTA Controller"'s rate
# again. Needed the whole project's clock tree raised too (4MHz -> 16MHz
# HSI) since 460800 was unreachable at 4MHz -- see CLAUDE.md for the full
# story.
FTA_BAUD = 460800
