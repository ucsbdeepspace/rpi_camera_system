...
/**
  * @brief This function handles USART2 global interrupt -- hand-added
  *        (see stm32l4xx_hal_msp.c's USART2_MspInit 1 block for why this
  *        wasn't CubeMX-generated). Drives the VCP command link's
  *        single-byte HAL_UART_Receive_IT reception (main.c).
  */
